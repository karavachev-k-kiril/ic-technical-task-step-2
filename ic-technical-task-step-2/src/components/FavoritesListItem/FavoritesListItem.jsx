  ...
  return (
    <div className="favorite-list-item">
      ...
      >
        <div className="list-item-content">
          ...
          {ws.address?.locality && (
            <>
              <br />
              <span className="list-item-location">{ws.address.locality}</span>
            </>
          )}
        </div>
      </a>
      ...
      <div className="list-item-actions">
        {ws.phoneNumber && (
          <a
            href={`tel:${ws.phoneNumber}`}
            className="list-item-action-phone"
            title={`Call ${ws.name}`}
          >
            <PhoneIcon />
          </a>
        ...
        <button
          onClick={() => onToggleFav(ws)}
          title="Toggle Favorite"
          className="favorite-list-toggle-button"
        >
