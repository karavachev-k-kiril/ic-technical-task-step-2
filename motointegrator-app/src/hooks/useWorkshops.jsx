...
export const useWorkshops = (initialCountry, initialPage, initialPerPage) => {

    const [isLoading, setIsLoading] = useState(true);
    const [workshops, setWorkshops] = useState([]);
    const [error, setError] = useState(null);
    const [pagination, setPagination] = useState({ page: 1, perPage: 10, totalPages: 1, total: 0 });
    const [availableFilters, setAvailableFilters] = useState({ brands: [] });
 ...
 useEffect(() => {
        ...
        const fetchParams = { country, pageToFetch: page, perPageToFetch: perPage, availability, brand, query };
 ...
 const loadMoreWorkshops = useCallback(async () => {
        ...
        try {
             const { country, availability, brand, query 
 } = searchParams;
             const fetchParams = { country, pageToFetch: nextPage, perPageToFetch: MAX_API_PER_PAGE, availability, brand, query };
